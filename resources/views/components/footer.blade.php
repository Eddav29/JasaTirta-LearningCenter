        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="space-y-4">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-lg font-semibold">Jasa Tirta Learning Center</span>
                </div>
                <p class="text-sm text-gray-400">
                    Pusat pelatihan profesional untuk analisis dan pengujian kualitas air sesuai standar SNI. 
                    Membangun kompetensi SDM berkualitas di bidang lingkungan hidup.
                </p>
            </div>
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li>
                        <a href="{{ url('/katalog') }}" class="text-gray-400 hover:text-blue-600 transition-colors">
                            Katalog Pelatihan
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('/pengajar') }}" class="text-gray-400 hover:text-blue-600 transition-colors">
                            Pengajar
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('/jadwal') }}" class="text-gray-400 hover:text-blue-600 transition-colors">
                            Jadwal
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('/kontak') }}" class="text-gray-400 hover:text-blue-600 transition-colors">
                            Kontak
                        </a>
                    </li>
                </ul>
            ...
            <div class="space-y-4">
                ...
                <div class="space-y-3 text-sm">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <span class="text-gray-400">info@jasatirta-lc.com</span>
                    </div>
                    <div class="flex items-start space-x-2">
                        ...
                        <span class="text-gray-400">
                            Jl. Lingkungan No. 123, Gedung Pembelajaran<br />
    ...
    <div class="border-t border-gray-800">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
                <p>&copy; {{ date('Y') }} Jasa Tirta Learning Center. Seluruh hak cipta dilindungi.</p>
