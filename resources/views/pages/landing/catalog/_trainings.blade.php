                        ...
                        <div class="border-t pt-4">
                            <div class="flex flex-col space-y-3">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    ...
                                    <a :href="`/user/registrations/select-schedule/${training.id}`" @click.stop class="inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-lg text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 transition"
