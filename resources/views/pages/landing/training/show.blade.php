        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div class="lg:col-span-2">
                    {{-- Training Image --}}
                    <div class="aspect-video rounded-2xl mb-8 overflow-hidden">
                        @if($training->image)
                            <img src="{{ Storage::url($training->image) }}" alt="{{ $training->title }}" class="w-full h-full object-cover">
                        @else
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100">
                    <div class="aspect-video overflow-hidden relative">
                        @if($relatedTraining->image)
                            <img src="{{ Storage::url($relatedTraining->image) }}" alt="{{ $relatedTraining->title }}" class="w-full h-full object-cover">
                        @else
                            <div class="bg-linear-to-br from-blue-500 to-blue-700 w-full h-full flex items-center justify-center">
