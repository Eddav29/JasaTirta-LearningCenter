        ...
        <form action="{{ route('admin.trainings.update', $training) }}" method="POST" class="p-6 space-y-6">
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="3" required
                    ...
                    placeholder="Masukkan deskripsi singkat pelatihan">{{ old('description', $training->description) }}</textarea>
                @error('description')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <input type="number" id="duration" name="duration" value="{{ old('duration', $training->duration) }}" required min="1"
                ...
                <div>
                    ...
                    <input type="number" id="price" name="price" value="{{ old('price', $training->price) }}" required min="0" step="0.01"
                ...
                <div>
                    ...
                    <input type="number" id="capacity" name="capacity" value="{{ old('capacity', $training->capacity) }}" required min="1"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" id="learning_hours" name="learning_hours" value="{{ old('learning_hours', $training->learning_hours) }}" min="1"
                ...
                <div>
                    ...
                    <input type="text" id="training_methods" name="training_methods" value="{{ old('training_methods', $training->training_methods) }}"
            ...
            <div>
                ...
                <textarea id="certification_note" name="certification_note" rows="2"
                    ...
                    placeholder="Masukkan catatan sertifikasi">{{ old('certification_note', $training->certification_note) }}</textarea>
