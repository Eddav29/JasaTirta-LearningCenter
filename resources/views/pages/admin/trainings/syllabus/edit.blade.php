...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600 mt-1">Edit kurikulum untuk pelatihan: <span class="font-semibold">{{ $training->title }}</span></p>
        </div>
    ...
    <div class="bg-white rounded-lg border border-gray-200">
        <form action="{{ route('admin.trainings.syllabus.update', [$training, $syllabus]) }}" method="POST" 
              x-data="{
                  topics: {{ json_encode($syllabus->topics->pluck('topic')->toArray()) }},
                  addTopic() {
                      this.topics.push('');
                  },
                  removeTopic(index) {
