...
>
    ...
    <div class="flex items-center justify-between h-20 px-5 border-b border-gray-200">
        <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3" x-show="desktopSidebarOpen || !window.matchMedia('(min-width: 1024px)').matches">
            <img src="{{ asset('images/logo.png') }}" alt="JTLC Logo" class="h-13 w-auto">
            <div>
                <img src="{{ asset('images/logo-teks.png') }}" alt="Jasa Tirta I Learning Center" class="h-40 w-auto mt-6">
                <span class="text-xs font-medium text-gray-600">Admin Panel</span>
            </div>
        </a>
        
        <div x-show="!desktopSidebarOpen" class="hidden lg:flex w-full justify-center">
            <img src="{{ asset('images/logo.png') }}" alt="JTLC Logo" class="h-12 w-auto">
        </div>
